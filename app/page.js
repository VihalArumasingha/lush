  ...
  return (
    <div>
      <div className="main-div relative isolate flex">
        ...
        <div className="relative z-10 flex-[50%]">
          ...
          <div className="mt-[40px] mb-[40px]">
            <a href="./products"><button className="w-[224px] h-[50px] rounded-full border border-solid border-black mr-[40px]">
              View Menu
            </button></a>
            <a href="./about"><button className="w-[224px] h-[50px] rounded-full border border-solid border-black">
              About Us
            </button></a>
          </div>
      ...
      <div className="flex flex-col items-center w-full">
        <a href="./products"><div className="flex items-center justify-center text-white bg-black mt-[60px] w-[300px] h-[50px] rounded-[100px] cursor-pointer">
          Show All &rarr;
        </div></a>
      </div>
      ...
      <div className="w-[100%] bg-black text-white rounded-[100px] mt-[104px] p-[30px] pr-[100px]">
        ...
        <div className="flex w-full gap-15">
          ...
          <div className="flex-1">
            ...
            <a href="./about"><button className="text-black bg-white rounded-[100px] w-[300px] h-[50px] mt-[80px]">About Us</button></a>
          </div>
        </div>
      </div>
      ...
      <div className="w-[100%] bg-black text-white rounded-[100px] mt-[104px] p-[30px] pr-[100px]">
        ...
        <div className="flex w-full gap-15">
          ...
          <div className="flex-1">
            ...
            <a href="./contact"><button className="text-black bg-white rounded-[100px] w-[300px] h-[50px] mt-[80px]">Contact Us</button></a>
          </div>
          <div className="flex-1">
